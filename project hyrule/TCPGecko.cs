...
namespace Hyrule
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (Hyrule.ValidMemory.rangeCheckId(startdump) != Hyrule.ValidMemory.rangeCheckId(enddump))
            {
                enddump = Hyrule.ValidMemory.ValidAreas[Hyrule.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!Hyrule.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!Hyrule.ValidMemory.validAddress(address))
            {
                return 0;
            }
